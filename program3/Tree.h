...
class Tree {
    ...
    public:
        ...
        Tree& operator=(const Tree&) = delete;   // Disable copy assignment operator
    ...
    private:
        ...
        // Print functions
        void preOrder(Node* node) const;    // Recursive print preorder function
        void inOrder(Node* node) const;     // Recursive print inorder function
        void postOrder(Node* node) const;   // Recursive print postorder function
};
